...
export default function AddRecordModal() {
  ...
  useEffect(() => {
    if (isOpen) {
      if (isEditMode && editingUser) {
        // Edit mode: Fill data từ editingUser
        setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ Validate avatar CHỈ khi Add mode
    ...
    // ✅ Xử lý avatar
    let avatarUrl = editingUser?.avatar || ""; // Giữ avatar cũ nếu Edit mode
    ...
    try {
      if (isEditMode) {
        // TODO: Dispatch editUser action
        console.log("Edit user:", editingUser.id, recordData);
        alert("Chức năng sửa đang trong quá trình phát triển!");
      } else {
        ...
        <form id="addRecordForm" onSubmit={handleSubmit}>
          ...
          <div className="form-group avatar-group">
            ...
            <input
              ...
              required={!isEditMode} // ← Chỉ required khi Add
            />
          </div>
