...
const getSavedLimit = () => {   // lấy limit đã lưu trong ls
    ...
    return saved ? parseInt(saved) : 10; // chưa lưu mặc định là 10
};

const getSavedSortBy = () => {
    return localStorage.getItem("sortBy") || "id";  // chưa lưu mặc định là id
};

const getSavedOrder = () => {
    return localStorage.getItem("order") || "asc";  // mặc định là tăng
};
